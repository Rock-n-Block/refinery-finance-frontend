  ...
  return (
    ...
    >
      <div className="m-buy-tickets__content">
        <div className="m-buy-tickets__title text-lg text-purple text-bold">Buy Tickets</div>
        <div className="m-buy-tickets__counter box-f-ai-c">
          <div
            className="m-buy-tickets__counter-btn box-f-c text-md text-purple text-med"
          ...
          <div className="m-buy-tickets__counter-box box-f-c">
            <InputNumber
              ...
              className="m-buy-tickets__counter-input text-purple h2 text-bold"
            />
          </div>
          <div
            className="m-buy-tickets__counter-btn box-f-c text-md text-purple text-med"
